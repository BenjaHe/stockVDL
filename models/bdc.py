...
class ResPartner(models.Model):
    ...
    num_mon_comptable = fields.Char(string='Numéro de mon comptable', required=False, related='user.comptable.num_comptable', help='Le numéro du comptable qui m est renseigné.')
